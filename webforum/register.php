...
<div id="wrap-body">
    <div class="chunk">
        <form id="register" method="post" action="check_register.php">
            ...
            <div class="panel">
                <div class="inner">
                    ...
                    <fieldset class="fields2">
                        <dl>
                            <dt><label for="username">Username:</label><br><span>Username must be between 4 characters and 30 characters long and use only alphanumeric characters.</span></dt>
                        ...
                        <dl>
                            <dt><label for="new_password">Password:</label><br><span>Must be between 4 characters and 16 characters.</span></dt>
